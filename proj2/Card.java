 ...
 *
 * @author John K. Estell adapted by Patti Ordonez, edited by Javier Santiago
 * @version 1.0
 */
public class Card implements Comparable {
   ...
   */
   public int compareTo( Object otherCardObject ) {
      ...
      int rankIndex1 = getRankIndex(rankValue);
      int rankIndex2 = getRankIndex(otherCard.rankValue);

      int suitIndex1 = getSuitIndex(suitValue);
      int suitIndex2 = getSuitIndex(otherCard.suitValue);
